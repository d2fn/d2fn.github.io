...
Hover any time period in the above charts and they will all orient themselves to the same time period.
...
fr.parse("/data/fr.csv", function(list) {
    ...
    classHabitatsGraph(classHabitatsContext, classByHabitat);
...
function classHabitatsGraph(context, data) {
    ...
    var xscale = d3.scale.ordinal()
        ...
        .rangeRoundBands([120, width], 0.05);
