...
<svg id="phylum-habitats" class="centered"/>
...
fr.parse("/data/fr.csv", function(list) {
    ...
    var chartContext = {
        ...
        sync = {
            context: [ chartContext, treeRingContext, habitatGraphContext, phylumGraphContext ],
    ...
    phylumGraph(phylumGraphContext, phylumByHabitat, phylumTimeline);
...
function phylumGraph(context, data, tl) {
