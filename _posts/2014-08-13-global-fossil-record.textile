...
At least in terms of number of distinct species, the majority of life on Earth appears to be marine-based. This listing also makes clear the trend towards terrestrial life. So far our data and its visuals agree with the general consensus in the scientific community that <a href="http://en.wikipedia.org/wiki/Evolutionary_history_of_life">life began in the ocean and later moved onto land</a>.
...
The fossil record indicates that diversity of life has been increasing over time as far back as we can see.
