---
layout: post
title: "Grab a Shovel Pt 1: Global Fossil Record"
---
...
The following circular chart displays the same information in a different way. It can be thought of as reading the rings of a tree--the beginning of paleological time is in the center with the current era represented by the outer most ring. The arc width of each color represents the percentage of species occupying that habitat at that time. Hover over a ring to focus on only on that time period and prior.

<svg id="tree-rings" class="centered"/>

Now, looking at the total number of species over time shows that species diversity is moving up and to the right.

<svg id="total-habitats"/>

And now break down by habitat.

<svg id="habitat-habitats"/>

Let's zoom back out and look at how species diversity has varied by kingdom over time.
...
It may come as no surprise that the most diverse phylum is <a href="http://en.wikipedia.org/wiki/Chordate">chordata</a>. This is a huge portion of what we consider the animal kingdom today. Everything from <a href="http://en.wikipedia.org/wiki/Fish">fish</a> to <a href="http://en.wikipedia.org/wiki/Bird">birds</a> to <a href="http://en.wikipedia.org/wiki/Pogona_vitticeps">pogona vitticeps</a>. Even <a href="http://en.wikipedia.org/wiki/Human">humans</a> are considered chordates.

<em>Caveat emptor</em>

There are some important limitations to be aware of in this data set. We simply have presence information - e.g. <em>"did this species exist in this time period?"</em>. So while we can get a sense of diversity of life by habitat, kingdom, phylum, etc, we are left to look elsewhere for population counts. Furthermore, this data doesn't give a sense of <em>where</em> these species lived--and answering that question is made more difficult by the separation of <a href="http://en.wikipedia.org/wiki/Pangaea">Pangea</a> into the continents we know today.

It is also important to point out that this data set points out massive gaps in our understanding of how life has evolved into its current form. While six thousand species are included in this data set, <a href="http://www.unep.org/newscentre/default.aspx?DocumentID=2649&ArticleID=8838">Earth is home to an estimated 8.7 million species</a> today. Were the fossil record more complete, the problem of classifying species would be much more difficult. The differentials between each would grow smaller and smaller to the point that strict categorizations make less and less sense. The specialized life forms we see today came from the same place but we lack sufficient data to show the exact progression.

I'll leave further research as an exercise for the reader. There exists innumerable prior art on the topic. Nonetheless, it's possible to use data sets like this as a different kind of jumping off point for learning about a topic. And it's quite fun.
