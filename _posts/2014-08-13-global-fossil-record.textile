...
Large data sets can be intimidating. Curiosity of a subject area can be frustrating when there exists a large volume of information to consider but no clear place to start. What do we do when nascent curiosity outstrips our ability to ask intelligent questions?
...
This data indicates that whole planet species diversity has been forever increasing.
...
There are some important limitations to be aware of in this data set. We simply have presence information, i.e. <em>"did this species exist in this time period?"</em>. So while we can get a sense of diversity of life by habitat, kingdom, phylum, etc, we are left to look elsewhere for population counts. Furthermore, this data does not give a sense of <em>where</em> these species lived--and answering that question is made more difficult by the separation of <a href="http://en.wikipedia.org/wiki/Pangaea">Pangea</a> into the continents we know today.
...
I'll leave further research as an exercise for the reader. There exists innumerable prior art on the topic. Nonetheless, it is possible to use data sets like this as a different kind of jumping off point for learning about a topic. And it's quite fun.
