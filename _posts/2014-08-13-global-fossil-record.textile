...
There are some important limitations to be aware of in this data set. We simply have presence information - e.g. <em>"did this species exist in this time period?"</em>. So while we can get a sense of diversity of life by habitat, kingdom, phylum, etc, we are left to look elsewhere for population counts. Furthermore, this data does not give a sense of <em>where</em> these species lived--and answering that question is made more difficult by the separation of <a href="http://en.wikipedia.org/wiki/Pangaea">Pangea</a> into the continents we know today.
